...
hl.bind(
	mainMod .. " + CTRL + D",
	hl.dsp.exec_cmd("kitty --session ~/dotfiles/kitty/.config/kitty/sessions/hsguru_dev", { workspace = "22" })
)
hl.bind(
	mainMod .. " + CTRL + R",
	hl.dsp.exec_cmd("kitty --session ~/dotfiles/kitty/.config/kitty/sessions/hsguru_remote", { workspace = "13" })
)
hl.bind(
	mainMod .. " + CTRL + SHIFT + D",
	hl.dsp.exec_cmd("kitty --session ~/dotfiles/kitty/.config/kitty/sessions/hsguru_dev")
)
hl.bind(
	mainMod .. " + CTRL + SHIFT + R",
	hl.dsp.exec_cmd("kitty --session ~/dotfiles/kitty/.config/kitty/sessions/hsguru_remote")
)
...
-- Send shortcuts to specific programs
ANTI_GRAVITY_RUN = function()
	hl.dispatch(hl.dsp.send_shortcut({
		mods = "ALT",
		key = "return",
		window = "class:antigravity",
	}))
end
...
hl.bind(
	mainMod .. " + ALT  + b",
	hl.dsp.exec_cmd(shieldBase .. "am start -a android.intent.action.VIEW -d \"$(wl-paste | tr -d '[:space:]')\"")
)
for keys, keyevent in pairs({
	["s"] = "com.stremio.one",
	...
	hl.bind(
		mainMod .. " + ALT + " .. keys,
		hl.dsp.exec_cmd(shieldBase .. "monkey -p " .. keyevent .. " -c android.intent.category.LAUNCHER 1")
	)
end
