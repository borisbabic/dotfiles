-- adding awesome stuff locally so that luacheck knows about this
...
local globalkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "j",
      ...
      {description = "focus greater", group = "client"}
    ),
    awful.key({ modkey,           }, "k",
      function ()
        awful.client.focus.byidx(-1)
      ...
      {description = "focus lower", group = "client"}
    ),
    ...
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("reduce_backlight") end,
      ({description = "-5%", group = "hotkeys"})),

    -- volume
    awful.key({ }, "XF86AudioRaiseVolume", function () os.execute("pactl set-sink-volume @DEFAULT_SINK@ +1000") end,
      {description = "volume up", group = "hotkeys"}),
    awful.key({ }, "XF86AudioLowerVolume", function () os.execute("pactl set-sink-volume @DEFAULT_SINK@ -1000") end,
...
local clientkeys = my_table.join(
    ...
    awful.key({ modkey, "Control" }, "o",      function (c) c.opacity = 1.5 - c.opacity end,
              {description = "move to screen", group = "client"}),
    ...
    awful.key({ modkey,           }, "p",
        ...
        {description = "picture in picture", group = "client"}),
    awful.key({ modkey,  "Control"         }, "p",
        ...
        {description = "to 16:9 for floating", group = "client"}),
    awful.key({ modkey,           }, "n",
        function (c)
